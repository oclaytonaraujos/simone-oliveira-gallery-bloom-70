      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-playfair text-xl font-semibold">Simone Oliveira Art Gallery</h3>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="font-playfair text-xl font-semibold">Contato</h3>
          ...
          {/* Opening Hours */}
          <div className="space-y-4">
            <h3 className="font-playfair text-xl font-semibold">Horário de Funcionamento</h3>
