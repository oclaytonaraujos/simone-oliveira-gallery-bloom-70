...
const Index = () => {
  ...
  const stats = [
    { icon: Eye, label: 'Obras Expostas', value: '200+' },
    { icon: Users, label: 'Artistas', value: '50+' },
    { icon: Sparkles, label: 'Exposições', value: '25+' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute w-96 h-96 bg-gradient-to-r from-terracotta/10 to-light-blue/10 rounded-full blur-3xl floating"
          style={{
        ...
        />
        <div 
          className="absolute w-64 h-64 bg-gradient-to-r from-light-green/10 to-terracotta/10 rounded-full blur-3xl floating"
          style={{
      ...
      <section className="relative min-h-screen flex items-center justify-center gradient-hero">
        ...
        <div className={`text-center z-10 px-4 max-w-5xl mx-auto ${isLoaded ? 'hero-reveal' : 'opacity-0'}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <Link 
              to="/artists"
              className="px-8 py-4 border-2 border-terracotta text-terracotta font-inter font-medium rounded-full hover:bg-terracotta hover:text-white transition-all duration-300 hover:scale-105 active:scale-95"
            >
              Conhecer Artistas
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            {stats.map((stat, index) => (
              <div 
                key={stat.label} 
                className="glass-card p-6 text-center hover-lift stagger-animation"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="reveal-up">
              ...
              <Link 
                to="/about"
                className="inline-flex items-center text-terracotta font-inter font-medium hover:text-terracotta/80 transition-all duration-300 group"
              >
            ...
            <div className="reveal-up" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                ...
                <img 
                  ...
                  className="relative w-full h-full object-cover rounded-3xl shadow-modern hover-lift"
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div className="reveal-up">
              ...
              <div className="space-y-8">
                {[
                  { icon: MapPin, title: 'Localização', content: 'Rua das Artes, 123\nVila Madalena, São Paulo - SP\nCEP: 05414-001' },
                  { icon: Phone, title: 'Telefone', content: '(11) 3456-7890' },
                  { icon: Mail, title: 'E-mail', content: 'contato@simoneoliveiragallery.com' },
                ].map((item, index) => (
            ...
            <div className="h-96 lg:h-full min-h-[400px] rounded-3xl overflow-hidden shadow-modern hover-lift reveal-up" style={{ animationDelay: '0.3s' }}>
              <iframe
