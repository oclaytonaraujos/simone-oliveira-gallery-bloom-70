        ...
        <div className={`z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto ${isLoaded ? 'hero-reveal' : 'opacity-0'}`}>
          ...
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-lg mx-auto mb-8 sm:mb-12">
              {stats.map((stat, index) => (
                <div key={stat.label} className="bg-soft-beige/90 backdrop-blur-lg border border-gentle-green/30 rounded-xl p-3 sm:p-4 text-center hover-lift-elegant stagger-animation touch-manipulation" style={{
          ...
          <div className="mb-8 sm:mb-12">
            ...
            <div className="text-center mt-6 sm:mt-8">
              <Link to="/expositions" className="inline-flex items-center px-4 sm:px-6 py-3 bg-warm-terracotta text-soft-beige font-helvetica font-medium rounded-full hover:bg-warm-terracotta/90 transition-all duration-300 group shadow-elegant hover-lift-elegant text-sm sm:text-base touch-manipulation active:scale-95" style={{ minHeight: '48px' }}>
